            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="widget footer-widget text-widget">
                        ...
                        <p>+51-1 611 5050</p>
                        <img src="upload/logos/mc.png" alt="">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="widget footer-widget text-widget">
                        ...
                        <div class="col-md-6">
                            <ul style="list-style-type: none; margin-left: -30px; font-size: 14px">
                                <li><a href="/comercios" style="color: #fff">Comercios</a></li>
                                <li><a href="/contactanos" style="color: #fff">Contáctanos</a></li>
                                <li><a href="/atencion-al-cliente" style="color: #fff">Atención al Cliente</a></li>
                                <li><a href="/libro-de-reclamaciones" style="color: #fff">Libro de Reclamaciones</a></li>
                                <li><a href="/terminos-y-condiciones.pdf" target="_blank" style="color: #fff">Términos y Condiciones</a></li>
                                <!--<li><a href="transparencia.php" style="color: #fff">Transparencia</a></li>-->
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <p style="text-align: right">
                        <a href="https://www.indecopi.gob.pe/inicio" target="_blank">
                            <img src="https://www.jetperu.com.pe/img/indecopi.jpg" />
                        </a>
